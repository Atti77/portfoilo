    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          ...
          <Link href="/about" className="text-sm text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400">
            About
          </Link>
          <Link href="/skills" className="text-sm text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400">
            Skills
          </Link>
          <Link href="/projects" className="text-sm text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400">
            Projects
          </Link>
          <Link href="/contact" className="text-sm text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400">
            Contact
          </Link>
        </div>
      </div>
